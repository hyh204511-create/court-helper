...
test('versioned migrations create the required tables and constraints', async () => {
  ...
  try {
    ...
    const expectedColumns = {
      ...
      platform_accounts: ['id', 'label', 'secret_ciphertext', 'secret_iv', 'secret_tag', 'secret_version', 'enabled', 'deleted_at', 'created_by', 'created_at', 'updated_at', 'salesperson_name', 'assistant_name'],
